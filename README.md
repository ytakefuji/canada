...
In Figure, black line indicates the number of daily deaths while blue line shows the predicated number of daily deaths using 280 days. The red line indicates the predicted number of daily deaths changing the size of days from 100 days to 280 days.
